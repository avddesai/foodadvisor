...
<head>
	<title>Borivali Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\tcr.png">
 		<a href="#" class="containerText-Name">The Chcolate Room</a><br>
        ...
        <p class="containerIcon-LocationText">Borivali</p>
 		</div>
      <div class="restaurantcontainer2">
 		<img class="containerlogo" src="Images\5.png">
 		<a href="spice.php" class="containerText-Name">5 Spice</a><br>
 		<p class="containerText-Cusine">Chinese</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='5 Spice' ";
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Borivali</p>
 		...
 		<img class="containerlogo" src="Images\63.png">
 		<a href="#" class="containerText-Name">63 By-Lane</a><br>
 		<p class="containerText-Cusine">Cafe</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
        ...
        <p class="containerIcon-LocationText">Borivali</p>
 		...
 		<img class="containerlogo" src="Images\12.png">
 		<a href="#" class="containerText-Name">Twelve Monkeys</a><br>
 		<p class="containerText-Cusine">Chinese</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">5.0</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 700</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Borivali</p>
 		</div>
 		<div class="restaurantcontainer5">
 		<img class="containerlogo" src="Images\lotus.png">
 		<a href="#" class="containerText-Name">Lotus Leaf</a><br>
 		<p class="containerText-Cusine">Indian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.1</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
