...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\starbucks.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">Andheri Kurla Rd, Chakala,<br>Hanuman Nagar, Andheri East,<br></p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">Starbucks</p>
  		<img src="Images\star1.jpg" class="menu1">
  		<img src="Images\star2.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Starbucks' "; 
