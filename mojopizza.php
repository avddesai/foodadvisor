...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="mojor6">
  		<img src="Images\mojo.png" class="mojoimage1">
  		<img src="Images\loc.png" class="mojoimage2">
  		<p class="text1"> Shop 2, Ground floor, Siddik <br>Ibrahim Building,  D. B. Road, <br>Grant Road, Mumbai</p>
  		<img src="Images\money.png" class="mojoimage3">
  		<p class="text2">₹500 for two people (approx.)</p>
  		<img src="Images\cus.png" class="mojoimage4">
  		<p class="text3">Italian</p>
  		<img src="Images\rating.png" class="mojoimage5">
      <?php 
include('config.php');
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="mojorect1">
  		<p class="headingtext">Mojo Pizza</p>
      <img src="Images\mojo1.jpg" class="menu1">
  		<img src="Images\mojo2.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Mojo Pizza' "; 
