...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\cand.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">5AA Pali Hill, Bandra (W),<br>next to Learners Academy School,<br></p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">Candies</p>
  		<img src="Images\cand1.jpg" class="menu1">
  		<img src="Images\cand2.jpg" class="menu1">
      <img src="Images\cand3.jpg" class="menu1">
