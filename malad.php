 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\sfg.png">
 		<a href="sfg.php" class="containerText-Name">Stir Fry Grill</a><br>
 		...
 		<?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='Stir Fry Grill' ";
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Malad</p>
 		</div>
 		<div class="restaurantcontainer2">
 		<img class="containerlogo" src="Images\burrow.png">
 		<a href="#" class="containerText-Name">Burrow Cafe</a><br>
        ...
        <p class="containerIcon-LocationText">Malad</p>
 		...
 		<img class="containerlogo" src="Images\greens.png">
 		<a href="#" class="containerText-Name">Greens Restaurant</a><br>
        ...
        <p class="containerIcon-LocationText">Malad</p>
 		...
 		<img class="containerlogo" src="Images\poptates.png">
 		<a href="#" class="containerText-Name">Pop Tate's</a><br>
        ...
        <p class="containerIcon-LocationText">Malad</p>
 		...
 		<img class="containerlogo" src="Images\1441.png">
 		<a href="#" class="containerText-Name">1441 Pizzeria </a><br>
