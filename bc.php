...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\bombay.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">Shop No 12,13,14,<br>Patel Cooperative Housing Society,<br></p>
  		<img src="Images\money.png" class="modimage3">
  		<p class="text2">₹1000 for two people (approx.)</p>
  		<img src="Images\cus.png" class="modimage4">
  		<p class="text3">Indian</p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">The Bombay Curry</p>
  		<img src="Images\bc1.jpg" class="menu1">
  		<img src="Images\bc2.jpg" class="menu1">
      <img src="Images\bc3.jpg" class="menu1">
      <img src="Images\bc4.jpg" class="menu1">
      <img src="Images\bc5.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='The Bombay Curry' "; 
