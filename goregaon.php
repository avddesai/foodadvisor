...
<head>
	<title>Goregaon Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\tanatan.png">
 		<a href="#" class="containerText-Name">Tanatan-Kitchen</a><br>
        ...
        <p class="containerIcon-LocationText">Goregaon</p>
 		</div>
 		<div class="restaurantcontainer2">
 		<img class="containerlogo" src="Images\prithvi.png">
 		<a href="#" class="containerText-Name">Prithvi Cafe</a><br>
        ...
        <p class="containerIcon-LocationText">Goregaon</p>
 		...
 		<img class="containerlogo" src="Images\shiv.png">
 		<a href="shiv.php" class="containerText-Name">Shiv Sagar</a><br>
 		<p class="containerText-Cusine">Fast Food</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='Shiv Sagar' ";
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Goregaon</p>
 		...
 		<img class="containerlogo" src="Images\litle.png">
 		<a href="#" class="containerText-Name">Little Italy</a><br>
        ...
        <p class="containerIcon-LocationText">Goregaon</p>
 		...
 		<img class="containerlogo" src="Images\melting.png">
 		<a href="#" class="containerText-Name">Melting Pot</a><br>
 		<p class="containerText-Cusine">Indian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.8</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 2500</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Goregaon</p>
 		</div>
    </div>
