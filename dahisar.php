...
<head>
	<title>Dahisar Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\goof.png">
 		<a href="#" class="containerText-Name">Good Flippin' Burgers</a><br>
        ...
        <p class="containerIcon-LocationText">Dahisar</p>
 		...
 		<img class="containerlogo" src="Images\italy.png">
 		<a href="#" class="containerText-Name">Italy in a Box</a><br>
 		<p class="containerText-Cusine">Italian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.3</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 800</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Dahisar</p>
 		</div>
 		<div class="restaurantcontainer4">
 		<img class="containerlogo" src="Images\kc.png">
 		<a href="#" class="containerText-Name">kcroasters</a><br>
 		<p class="containerText-Cusine">Café</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.0</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        ...
        <p class="containerIcon-LocationText">Dahisar</p>
 		...
 		<img class="containerlogo" src="Images\bombay.png">
 		<a href="bc.php" class="containerText-Name">The Bombay Curry</a><br>
 		<p class="containerText-Cusine">Indian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='The Bombay Curry' ";
