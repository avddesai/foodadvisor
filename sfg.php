...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">Stir Fry Grill</p>
  		<img src="Images\sfg1.jpg" class="menu1">
  		<img src="Images\sfg2.jpg" class="menu1">
      <img src="Images\sfg3.jpg" class="menu1">
      <img src="Images\sfg4.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Stir Fry Grill' "; 
