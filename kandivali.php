...
<head>
	<title>Kandivali Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<a href="#" class="containerText-Name">Starbucks Coffee</a><br>
        ...
        <p class="containerIcon-LocationText">Kandivali</p>
 		</div>
 		<div class="restaurantcontainer2">
 		<img class="containerlogo" src="Images\bbqnation.png">
 		<a href="#" class="containerText-Name">Barbeque Nation</a><br>
        ...
        <p class="containerIcon-LocationText">Kandivali</p>
 		...
 		<img class="containerlogo" src="Images\mod.png">
 		<a href="mod.php" class="containerText-Name">Mad Over Donuts</a><br>
 		<p class="containerText-Cusine">Cafe</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<?php 
include('config.php');
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Kandivali</p>
 		...
 		<img class="containerlogo" src="Images\pizzahut.png">
 		<a href="#" class="containerText-Name">Pizza Hut</a><br>
