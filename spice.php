...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\5.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">Shop No.1,Virajdeep Apartment,<br>Eksar Rd, opposite Mayur Tower,<br></p>
  		<img src="Images\money.png" class="modimage3">
  		<p class="text2">₹800 for two people (approx.)</p>
  		<img src="Images\cus.png" class="modimage4">
  		<p class="text3">Chinese</p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">5-Spice</p>
  		<img src="Images\spice1.jpg" class="menu1">
  		<img src="Images\spice2.jpg" class="menu1">
      <img src="Images\spice3.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Candies' "; 
