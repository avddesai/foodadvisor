...
<head>
	<title>Mumbai Central Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\deli.png">
 		<a href="#" class="containerText-Name">Happiness Deli</a><br>
        ...
        <p class="containerIcon-DollarText">INR 400</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Mumbai Central</p>
 		</div>
 		<div class="restaurantcontainer2">
 		<img class="containerlogo" src="Images\merwan.png">
 		<a href="#" class="containerText-Name">B Merwan & co</a><br>
 		<p class="containerText-Cusine">Fast food </p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.9</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 100</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Mumbai Central</p>
 		</div>
 		<div class="restaurantcontainer3">
 		<img class="containerlogo" src="Images\mojo.png">
 		<a href="mojopizza.php" class="containerText-Name">MOJO Pizza</a><br>
 		<p class="containerText-Cusine">Italian </p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='Mojo Pizza' ";
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Mumbai Central</p>
 		...
 		<img class="containerlogo" src="Images\flute.png">
 		<a href="#" class="containerText-Name">Flute 24 Hrs</a><br>
 		<p class="containerText-Cusine">Chinese</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.2</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 1600</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Mumbai Central</p>
 		</div>
 		<div class="restaurantcontainer5">
 		<img class="containerlogo" src="Images\dz.png">
 		<a href="#" class="containerText-Name">Delhi Zaika</a><br>
 		<p class="containerText-Cusine">Indian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.5</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 1200</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Mumbai Central</p>
 		</div>
    </div>
