...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\shiv.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">Dharam Prem Apartment, 8,<br>Nehru Rd, Navpada,<br></p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">Shiv Sagar</p>
  		<img src="Images\shiv1.jpg" class="menu1">
  		<img src="Images\shiv2.jpg" class="menu1">
      <img src="Images\shiv3.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Shiv Sagar' "; 
