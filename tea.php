...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\tea.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">765, Juhu Church Rd,<br>Janki Kutir, Juhu Tara,<br></p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">Tea Villa Cafe</p>
  		<img src="Images\tea1.jpg" class="menu1">
  		<img src="Images\tea2.jpg" class="menu1">
      <img src="Images\tea3.jpg" class="menu1">
      <img src="Images\tea4.jpg" class="menu1">
      <img src="Images\tea5.jpg" class="menu1">
      <img src="Images\tea6.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Tea Villa Cafe' "; 
