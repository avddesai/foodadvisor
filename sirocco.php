...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="sirr6">
  		<img src="Images\sirocco.png" class="sirimage1">
  		<img src="Images\loc.png" class="sirimage2">
  		<p class="text1">Inch By Inch Body Temple,JP Road,<br>Panch Nagar,Versova,<br></p>
  		<img src="Images\money.png" class="sirimage3">
  		<p class="text2">₹1,200 for two people (approx.) Without alcohol</p>
  		<img src="Images\cus.png" class="sirimage4">
  		<p class="text3">Italian</p>
  		<img src="Images\rating.png" class="sirimage5">
  		<?php 
include('config.php');
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="sirrect1">
  		<p class="headingtext">Sirocco</p>
  		<img src="Images\sirocco1.jpg" class="menu1">
  		<img src="Images\sirocco2.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='Sirocco' "; 
