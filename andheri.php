...
<head>
	<title>Andheri Restaurant</title>
</head>
<body bgcolor="black">
<?php
               if (!isset($_SESSION['username'])) {?>
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	...
  	<div class="r8">
 		...
 		<img class="containerlogo" src="Images\sirocco.png">
 		<a href="sirocco.php" class="containerText-Name">Sirocco</a><br>
 		<p class="containerText-Cusine">Cafe</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
    <?php 
include('config.php');
$sql = "Select Round(AVG(rating),2) from review WHERE restaurant='Sirocco' ";
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      echo "<p class='containerText-Rating'>".$row['Round(AVG(rating),2)']."</p>";}}?>
        ...
        <p class="containerIcon-LocationText">Andheri</p>
 		...
 		<img class="containerlogo" src="Images\rodeo.png">
 		<a href="#" class="containerText-Name">Rodeo Pizza</a><br>
 		<p class="containerText-Cusine">Italian</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.9</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 900</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Andheri</p>
 		</div>
 		<div class="restaurantcontainer3">
 		<img class="containerlogo" src="Images\by.png">
 		<a href="#" class="containerText-Name">By The Bae</a><br>
 		<p class="containerText-Cusine">Fast Food</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.3</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        <p class="containerIcon-DollarText">INR 1500</p>
        <div class="containerIcon-LocationBox"><img src="Images\location.png" class="containerIcon-Location"></div>
        <p class="containerIcon-LocationText">Andheri</p>
 		</div>
 		<div class="restaurantcontainer4">
 		<img class="containerlogo" src="Images\cat.png">
 		<a href="#" class="containerText-Name">Cat Café Studio</a><br>
 		<p class="containerText-Cusine">Café</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">5.0</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
        ...
        <p class="containerIcon-LocationText">Andheri</p>
 		...
 		<img class="containerlogo" src="Images\burger.png">
 		<a href="#" class="containerText-Name">The Burger Shack</a><br>
 		<p class="containerText-Cusine">Fast Food</p>
 		<div class="containerIcon-BoxStar"><img src="Images\star.png" class="containerIcon-Star"></div>
 		<p class="containerText-Rating">4.7</p><br>
 		<div class="containerIcon-DollarBox"><img src="Images\dollar.png" class="containerIcon-Dollar"></div>
