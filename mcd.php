...
<div class="container">
 ...
 <a href="review.php" class="r3"> 
  ...
  <div class="r5">
  	<div class="modr6">
  		<img src="Images\mcd.png" class="modimage1">
  		<img src="Images\loc.png" class="modimage2">
  		<p class="text1">3rd Floor, Food Court,<br>Oberoi Mall,Gokuldham Colony,<br></p>
...
if ($result->rowCount() > 0){
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  	...
  	<div class="modrect1">
  		<p class="headingtext">McDonald's</p>
  		<img src="Images\mcd1.jpg" class="menu1">
  		<img src="Images\mcd2.jpg" class="menu1">
      <img src="Images\mcd3.jpg" class="menu1">
      <img src="Images\mcd4.jpg" class="menu1">
...
$query = "Select uname,rating,review from review WHERE restaurant='mcdonalds' "; 
